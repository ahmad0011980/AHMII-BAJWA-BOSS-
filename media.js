// ============================================
//      𝑨𝑯𝑴𝑰𝑰 𝑩𝑨𝑱𝑾𝑨 𝑩𝑶𝑺𝑺 BOT — COMMANDS/MEDIA.JS
...
const play = async (ctx) => {
  ...
  try {
    ...
    const detailsText = 
`🎧 *${toSmallCaps('𝑨𝑯𝑴𝑰𝑰 𝑩𝑨𝑱𝑾𝑨 𝑩𝑶𝑺𝑺  md music player')}*
...
> *${toSmallCaps('powered by 𝑨𝑯𝑴𝑰𝑰 𝑩𝑨𝑱𝑾𝑨 𝑩𝑶𝑺𝑺  abbasi')}*`;
...
const video = async (ctx) => {
  ...
  try {
    ...
    const detailsText = 
`📽️ *${toSmallCaps('𝑨𝑯𝑴𝑰𝑰 𝑩𝑨𝑱𝑾𝑨 𝑩𝑶𝑺𝑺  md video player')}*
...
> *${toSmallCaps('powered by 𝑨𝑯𝑴𝑰𝑰 𝑩𝑨𝑱𝑾𝑨 𝑩𝑶𝑺𝑺  abbasi')}*`;
    ...
    await sock.sendMessage(from, {
      ...
      mimetype: 'video/mp4',
      caption: `✅ *${result.title}*\n_ʙʏ ${toSmallCaps('𝑨𝑯𝑴𝑰𝑰 𝑩𝑨𝑱𝑾𝑨 𝑩𝑶𝑺𝑺  md')}_`
    }, { quoted: msg });
